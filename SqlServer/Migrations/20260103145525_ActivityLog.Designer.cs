...
namespace SqlServer.Migrations
{
    ...
    [Migration("20260103145525_ActivityLog")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoreEntities.Model.AIAction", b =>
                {
            ...
            modelBuilder.Entity("CoreEntities.Model.ActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoreEntities.Model.ChatMessage", b =>
                {
                    b.Property<Guid>("MessageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoreEntities.Model.Conversation", b =>
                {
                    b.Property<Guid>("ConversationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoreEntities.Model.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CoreEntities.Model.User", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CoreEntities.Model.UserFL", b =>
                {
                    ...
                    b.Property<bool?>("IsResetPasswordUsed")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CoreEntities.Model.AIAction", b =>
                {
                    b.HasOne("CoreEntities.Model.ChatMessage", "Message")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreEntities.Model.ActivityLog", b =>
                {
                    b.HasOne("CoreEntities.Model.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("CoreEntities.Model.ChatMessage", b =>
                {
                    b.HasOne("CoreEntities.Model.Conversation", "Conversation")
                        .WithMany("Messages")
